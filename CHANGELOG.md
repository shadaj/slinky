...
## [v0.7.5](https://slinky.dev)
### Highlights :tada:
+ Add support for React 18 ([PR #665](https://github.com/shadaj/slinky/pull/665))
+ Add syntactic sugar for capture phase handlers, such as 'onKeyDownCapture' ([PR #695](https://github.com/shadaj/slinky/pull/695))

### Bug Fixes :bug:
+ Correctly handle `@react` components with a `children: Seq[ReactElement]` prop ([PR #721](https://github.com/shadaj/slinky/pull/721))

## [v0.7.4](https://7cd6bee1.slinky.pages.dev/)
### Highlights :tada:
...
+ The interface to `createPortal` has changed, but libraries should not be affected since this is typically intended for end-users ([PR #594](https://github.com/shadaj/slinky/pull/594))
