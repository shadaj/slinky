        ...
        val applyMethods = objStats.flatMap {
          case defn@q"case class Props[..$tparams](...${caseClassparamssRaw}) extends ..$_ { $_ => ..$_ }" =>
            ...
            val caseClassApply = if (childrenParam.isDefined) {
              ...
              q"""def apply[..$tparams](...$paramssWithoutChildren)(${childrenParam.get}): _root_.slinky.core.KeyAndRefAddingStage[_root_.scala.scalajs.js.Object] =
                    $body"""
            } else {
              q"""def apply[..$tparams](...$paramssWithoutChildren): _root_.slinky.core.KeyAndRefAddingStage[_root_.scala.scalajs.js.Object] =
          ...
          q"def apply(props: component.Props): _root_.slinky.core.KeyAndRefAddingStage[_root_.scala.scalajs.js.Object] = component.apply(props)"
        )
