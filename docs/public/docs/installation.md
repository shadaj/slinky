...
```scala
libraryDependencies += "me.shadaj" %%% "slinky-core" % "0.6.2" // core React functionality, no React DOM
libraryDependencies += "me.shadaj" %%% "slinky-web" % "0.6.2" // React DOM, HTML and SVG tags
libraryDependencies += "me.shadaj" %%% "slinky-native" % "0.6.2" // React Native components
libraryDependencies += "me.shadaj" %%% "slinky-hot" % "0.6.2" // Hot loading, requires react-proxy package
libraryDependencies += "me.shadaj" %%% "slinky-scalajsreact-interop" % "0.6.2" // Interop with japgolly/scalajs-react
