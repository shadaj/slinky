    ...
    div(
      div(
        ...
        div(
          ...
          p(
            ...
            code("render()"),
            "method that returns what to display based on the input data, but also define a ",
            code("Props"),
            " type that defines the input data shape. ",
      ...
      div(
        ...
        div(
          ...
          p(
            "Slinky components, just like React components, can maintain internal state data (accessed with ",
            code("state"),
            ").",
            " When a component's state data changes after an invocation of ",
            code("setState"),
            ", the rendered markup will be update by re-invoking ",
            code("render()"),
            "."
          )
        ),
