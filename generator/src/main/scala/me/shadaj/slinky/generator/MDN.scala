...
class MDN extends TagsProvider {
  ...
  val extraAttributes = List(
    ...
    Attr("onMouseDown", "EventHandler") -> "",
    Attr("onMouseEnter", "EventHandler") -> "",
    Attr("onMouseLeave", "EventHandler") -> "",
    Attr("onMouseMove", "EventHandler") -> "",
    Attr("onMouseOut", "EventHandler") -> "",
    Attr("onMouseOver", "EventHandler") -> "",
    Attr("onMouseUp", "EventHandler") -> "",
    Attr("onMouseWheel", "EventHandler") -> "",
